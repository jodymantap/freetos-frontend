      ...
      <div className="grid grid-cols-1 gap-10 justify-between lg:grid-cols-3 sm:grid-cols-2">
        <div className="shadow-md animate-pulse">
          ...
          <div className="w-5/6 mx-auto pb-4 pt-2">
            <div className="w-20 h-6 bg-gray-200 my-2 rounded-sm"></div>
            <div className="w-full h-4 bg-gray-200 mt-4"></div>
            <div className="w-3/4 h-4 bg-gray-200 mb-4 mt-2"></div>
            <div className="w-20 h-4 bg-gray-200 mb-8 mt-2"></div>                 
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="w-full space-y-2 grid">
                <div className="w-16 h-3 bg-gray-200 justify-self-end"></div>
                <div className="w-full h-4 bg-gray-200"></div>
              </div>
            </div>
          </div>
